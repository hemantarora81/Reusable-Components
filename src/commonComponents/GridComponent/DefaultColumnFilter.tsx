...
const DefaultColumnFilter: React.FC<DefaultColumnFilterProps & { darkMode?: boolean }> = ({ 
  ...
  // Use currentFilteredData if available, otherwise fall back to preFilteredRows
  const dataForOptions = currentFilteredData || preFilteredRows;
  ...
  const {
    ...
    filterValue,
    columnId: id,
    preFilteredRows: dataForOptions // Pass the filtered data here
  });
